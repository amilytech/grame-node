...
namespace com.grame.services.sigs.metadata {
    /**
     * Represents metadata about the signing activities of a grame cryptocurrency account.
     * 
     * @author AmilyTech
     ...
     * @class
     */
    export class AccountSigningMetadata {
    ...
    AccountSigningMetadata["__class"] = "com.grame.services.sigs.metadata.AccountSigningMetadata";
